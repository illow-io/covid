    ...
    return (
        <>
            ...
            <Box pad="large">
                ...
                <Heading level={5} margin={{ horizontal: "none", top: "medium", bottom: "small" }}>Español</Heading>
                ...
                <Heading level={5} margin={{ horizontal: "none", top: "medium", bottom: "small" }}>English</Heading>
