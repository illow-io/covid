...
const Share = props => {
    ...
    return (
        <Box style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            <FacebookShareButton quote={facebookSpanishText} hashtag="#MyCovidRisk" url="https://mycovidrisk.org"><FacebookIcon size={50} round={true} /></FacebookShareButton>
            <TwitterShareButton title={twitterSpanishText} hashtags={['SoyParteDeLaSolucion', 'MyCovidRisk', 'MiRiesgoCovid']} url="https://mycovidrisk.org"><TwitterIcon size={50} round={true} /></TwitterShareButton>
            <WhatsappShareButton title={whatsappSpanishText} url="https://mycovidrisk.org"><WhatsappIcon size={50} round={true} /></WhatsappShareButton> 
        </Box>
    )
};
